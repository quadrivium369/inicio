  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center max-w-3xl p-3 py-32 mx-auto">
        ...
        <Link
          to={`/colecciones/`}
          className="block px-12 py-3 my-12 font-mono text-2xl font-bold text-center text-indigo-900 bg-white shadow-md hover:bg-indigo-100 hover:text-indigo-900"
        >
          Ver recursos
        </Link>
      </div>
